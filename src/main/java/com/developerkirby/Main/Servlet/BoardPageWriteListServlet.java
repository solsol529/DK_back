...
@WebServlet("/BoardPageWriteListServlet")
public class BoardPageWriteListServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		System.out.println("전달 받은 게시판 이름 : " + reqBoardName);
		System.out.println("전달 받은 게시판 OFFSET : " + offsetNum);
		
		PrintWriter out = response. getWriter();
		if(!reqCmd.equals("BoardPageWriteList")) {
		...
		List<WriteVO> list = dao.writeListSelect(reqBoardName,offsetNum,limitNum);
