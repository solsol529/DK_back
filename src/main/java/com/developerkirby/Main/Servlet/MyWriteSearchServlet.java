...
@WebServlet("/MyWriteSearchServlet")
public class MyWriteSearchServlet extends HttpServlet {
...
//		int intNum = Integer.parseInt(reqmemberNum);
		...
		List<WriteVO> list = dao.myWriteSelect(reqmemberNum,offsetNum,limitNum);
